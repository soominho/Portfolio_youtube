    ...
    return (
        <header id='header' role='banner'>
            ...
            <div className='header__sns'>
                <ul>
                    <li>
                        <a href='https://github.com/soominho' rel='noopener noreferrer'>
                            <AiFillGithub />
                        </a>
                    </li>
                    <li>
                        <a href='https://youtube.com/@user-td6xu8wi8e?si=uWhNVUqHgapkHkyp' rel='noopener noreferrer'>
                            <AiFillYoutube />
                        </a>
                    </li>
                    <li>
                        <a href='https://codepen.io/Soo-min' rel='noopener noreferrer'>
                            <AiOutlineCodepen />
                        </a>
                    </li>
                    <li>
                        <a href='https://www.instagram.com/soomin9611' rel='noopener noreferrer'>
                            <AiOutlineInstagram />
                        </a>
                    </li>
                </ul>
